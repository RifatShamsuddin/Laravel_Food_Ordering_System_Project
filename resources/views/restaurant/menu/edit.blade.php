        ...
        <div class="row">
            <div class="offset-3 col-md-5 my-lg-5">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('dish_update', $dish->dish_id) }}" method="Post"
                            ...
                            <div class="form-group">
                                <label>Price</label>
                                <input type="text" class="form-control" value="{{ $dish->dish_price }}"
                                    name="dish_price">
                            </div>
                            <div class="form-group">
                                <label>Image</label>
                                <input type="file" class="form-control" name="dish_image"
                                    value="{{ asset('/adminDashboardSourceFiles') }}/dish_image">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <div class="radio">
